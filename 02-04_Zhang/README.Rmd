...
date <- "02/04/2021"
quarter <- "Winter2021"
week_folder <- "01-28_Zhang"
title <- "Chinese Online Discussion around Democracy in the 2010s"
speaker <- "Yinxian Zhang"
department <- "Department of Sociology"
university <- "CUNY Queens College"
github_home <- "https://github.com/uchicago-computation-workshop"
#Update Weekly
issues_url <- "https://github.com/uchicago-computation-workshop/Winter2021/issues/4"
zoom_url <- "https://uchicago.zoom.us/meeting/register/tJEtf--gpzMoE90L_aLX4O7BraXnn0WO3BnN"
#Papers
week_paper_ref1 <- ""
week_paper_file1 <- ""
